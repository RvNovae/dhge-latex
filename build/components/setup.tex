...
\def\acp{\stepcounter{acronum}\oldacp}

\def\oldAcp{} \let\oldAcp=\Acp
\def\Acp{\stepcounter{acronum}\oldAcp}

\def\oldiac{} \let\oldiac=\iac
\def\iac{\stepcounter{acronum}\oldiac}
...
\def\acs{\stepcounter{acronum}\oldacs}

\def\oldAcs{} \let\oldAcs=\Acs
\def\Acs{\stepcounter{acronum}\oldAcs}

\def\oldacsp{} \let\oldacsp=\acsp
\def\acsp{\stepcounter{acronum}\oldacsp}

\def\oldAcsp{} \let\oldAcsp=\Acsp
\def\Acsp{\stepcounter{acronum}\oldAcsp}

\def\oldiacs{} \let\oldiacs=\iacs
\def\iacs{\stepcounter{acronum}\oldiacs}
...
\def\acl{\stepcounter{acronum}\oldacl}

\def\oldAcl{} \let\oldAcl=\Acl
\def\Acl{\stepcounter{acronum}\oldAcl}

\def\oldaclp{} \let\oldaclp=\aclp
\def\aclp{\stepcounter{acronum}\oldaclp}

\def\oldAclp{} \let\oldAclp=\Aclp
\def\Aclp{\stepcounter{acronum}\oldAclp}

\def\oldiacl{} \let\oldiacl=\iacl
\def\iacl{\stepcounter{acronum}\oldiacl}
...
\def\aca{\stepcounter{acronum}\oldaca}

\def\oldAca{} \let\oldAca=\Aca
\def\Aca{\stepcounter{acronum}\oldAca}

\def\oldacap{} \let\oldacap=\acap
\def\acap{\stepcounter{acronum}\oldacap}

\def\oldAcap{} \let\oldAcap=\Acap
\def\Acap{\stepcounter{acronum}\oldAcap}

\def\oldiaca{} \let\oldiaca=\iaca
\def\iaca{\stepcounter{acronum}\oldiaca}
...
\def\acf{\stepcounter{acronum}\oldacf}

\def\oldAcf{} \let\oldAcf=\Acf
\def\Acf{\stepcounter{acronum}\oldAcf}

\def\oldacfp{} \let\oldacfp=\acfp
\def\acfp{\stepcounter{acronum}\oldacfp}

\def\oldAcfp{} \let\oldAcfp=\Acfp
\def\Acfp{\stepcounter{acronum}\oldAcfp}

\def\oldiacf{} \let\oldiacf=\iacf
\def\iacf{\stepcounter{acronum}\oldiacf}
