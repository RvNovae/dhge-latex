...
\pagenumbering{gobble}
    ...
    \if\CHASGLO 1 % füge das Glossar nur hinzu, wenn die Option in config.tex gesetzt ist
        \printnoidxglossaries
        \cleardoublepage
    \else \cleardoublepage % Glossaries fügt von selbst einen page break ein - nur notwendig, wenn KEIN Glossar
    \fi
